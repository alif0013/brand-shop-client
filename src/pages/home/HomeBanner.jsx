        ...
        <div>
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <img src="https://i.ibb.co/MSgWsVL/banner-one-main-img.png" className="max-w-sm md:max-w-md rounded-lg" />
                    <div>
                        <h1 className="text-3xl md:text-5xl font-bold">Your Brand For Future!</h1>
